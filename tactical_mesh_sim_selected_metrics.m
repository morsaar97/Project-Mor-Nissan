...
snrFailThreshold_dB = 10; % links with SNR < 10 dB are excluded from routing
...
rx_dBm=Tx_dBm-pl; %final recived power.
end
...
for k=1:np
    ...
    for i=1:H
        ...
        txDelay_s = (pktB*8) / link.cap_bps(u,v);   % packet transmission time
        ...
        snrDB = hS(i);
        % Continuous SNR-to-packet-success model
        % At 10 dB, packet success is approximately 97%.
        snrMid_dB = 4.2;
        snrSlope  = 0.6;
